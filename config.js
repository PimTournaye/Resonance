...
maxMSP = false; // if true, the program will function as if it's a Node for Max project
modeMIDI = true // if true, the program will function as if talking to a MIDI device
keyChangeEvent = true // if true, this will trigger a key change if there are no balls for a certain amount of time (configured in KEY_CHANGE_TIMER below) [EXPERIMENTAL]

// MIDI INPUT / OUTPUT DEVICE -- CHANGE TO THE DEVICE YOU WANT TO USE IF USING MIDI
